      ...
      (props) => {
        ...
        return React.createElement('div', { style },
          ...
          React.createElement('div', { style: row },
            ...
            s.faultedCount ? React.createElement('span', { style: { color: '#c0392b' } }, ' · 待重启恢复 ' + s.faultedCount) : null,
          ),
          s.lastError ? React.createElement('div', { style: { ...err, marginTop: 4 } }, String(s.lastError)) : null,
          Array.isArray(s.skipReasons) && s.skipReasons.length > 0 ? React.createElement('div', { style: { ...row, ...muted } },
            '跳过详情: ' + s.skipReasons.slice(0, 12).join('; '),
          ) : null,
